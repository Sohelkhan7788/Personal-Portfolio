...
const AdminMessages = () => {
  ...
  const fetch = () => {
    ...
    axios.get('/api/contact/admin/all')
      .then(r => {
        console.log("MESSAGES API:", r.data); // 🔥 debug
        ...
        } else if (Array.isArray(r.data.messages)) {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={fetch}
          className="p-2.5 rounded-xl bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-gray-200 transition"
        >
          <HiRefresh size={20}/>
        </button>
      </div>
      ...
      {selected && (
        ...
        >
          <div
            className="bg-white dark:bg-[#1e2a4a] rounded-3xl p-8 w-full max-w-lg shadow-2xl"
